...
@property (nonatomic) IBInspectable BOOL enableMaterialPlaceHolderForMoreDisplace;

@property (nonatomic) IBInspectable BOOL enableMaterialPlaceHolderForbigfont;
@end
