...
- (void)setup {
    ...
    self.textView.backgroundColor=[UIColor clearColor] ;
    self.textView.frame=CGRectMake(30, 0, 300, 30);
    ...
    self.placeholderLabel = [[UILabel alloc] initWithFrame:CGRectMake(8, self.viewPadding, self.frame.size.width, 30)];
...
- (void)setFont:(UIFont *)font {
    ...
    self.placeholderLabel.frame = CGRectMake(8, self.viewPadding, self.frame.size.width, 30);
}
...
- (void)layoutView {
    ...
    CGRect textViewFrame = CGRectMake(0, -30, self.textView.frame.size.width, self.lineHeight/* - 2 * kVerticalPadding*/);
    ...
    self.scrollView.contentSize = CGSizeMake(self.scrollView.frame.size.width, newHeight-50);
    ...
    if (self.frame.size.height != newHeight){
        ...
        self.scrollView.frame=CGRectMake(30, 0, 300, 40);
