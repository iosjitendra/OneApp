                     ...
                     withGroupId:(NSNumber *)groupID
{
    ...
    {
        CH_ChatScreen *lObj = [[CH_ChatScreen alloc] init];
...
-(void)ALDefaultChatViewSettings
{
    ...
    /*********************************************  NAVIGATION SETTINGS  ********************************************/
    ////UIColor *bgColor =[UIColor colorWithRed:140/255.0 green:190/255.0 blue:194/255.0 alpha:1];
    [ALApplozicSettings setStatusBarBGColor:[UIColor colorWithRed:140/255.0 green:190/255.0 blue:194/255.0 alpha:1]];
    ...
    [ALApplozicSettings setColorForNavigation: [UIColor colorWithRed:140/255.0 green:190/255.0 blue:194/255.0 alpha:1]];
...
//    [ALApplozicSettings setColorForReceiveMessages:[UIColor colorWithRed:255/255 green:255/255 blue:255/255 alpha:1]];//original
//    [ALApplozicSettings setColorForSendMessages:[UIColor colorWithRed:66.0/255 green:173.0/255 blue:247.0/255 alpha:1]];
    
    [ALApplozicSettings setColorForReceiveMessages:[UIColor colorWithRed:255/255 green:255/255 blue:255/255 alpha:1]];//jitendra
    //[ALApplozicSettings setColorForSendMessages:[UIColor colorWithRed:205/255.0 green:234/255.0 blue:224/255.0 alpha:1]];
     [ALApplozicSettings setColorForSendMessages:[UIColor colorWithRed:133/255.0 green:232/255.0 blue:200/255.0 alpha:1]];
    /****************************************************************************************************************/
   ...
   // [ALUserDefaultsHandler setDeviceApnsType:(short)DEVELOPMENT];//jitendra
    ...
    UIColor * sendButtonColor =[UIColor clearColor]; /*  SET COLOR FOR SEND BUTTON   */
    [ALApplozicSettings setColorForSendButton:sendButtonColor];
    [ALApplozicSettings setColorForTypeMsgBackground:[UIColor whiteColor]];     /*  SET COLOR FOR TYPE MESSAGE OUTER VIEW */
    [ALApplozicSettings setMsgTextViewBGColor:[UIColor whiteColor]];        /*  SET BG COLOR FOR MESSAGE TEXT VIEW */
    ...
    [ALApplozicSettings setBGColorForTypingLabel:[UIColor whiteColor]]; /*  SET COLOR FOR TYPING LABEL  */
    [ALApplozicSettings setTextColorForTypingLabel:[UIColor colorWithRed:140/255.0 green:190/255.0 blue:194/255.0 alpha:1]]; /*  SET COLOR FOR TEXT TYPING LABEL  */
    /****************************************************************************************************************/
    ...
    [ALApplozicSettings setCallOption:NO];                                 /*  IF CALL OPTION NEEDED   */
    /****************************************************************************************************************/
    ...
    [ALApplozicSettings setFontFace:@"Karla-Regular"];
    [ALApplozicSettings setChatWallpaperImageName:@"ChatBG.png"];
